...
// ── Data fetching (no auth required — public anon client) ─────────────────────
      ...
      <main className="flex-1 w-full">
        ...
        <section className="max-w-6xl mx-auto px-4 pt-16 pb-20 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              href="#communities"
              className="inline-flex items-center justify-center rounded-xl bg-terracotta text-white font-semibold text-base px-7 py-3.5 hover:bg-terracotta/90 transition w-full sm:w-auto"
            >
              Find a community near you
            </a>
            <Link
              href="/login"
              className="inline-flex items-center justify-center rounded-xl border border-gray-200 bg-white text-charcoal font-semibold text-base px-7 py-3.5 hover:bg-gray-50 transition w-full sm:w-auto"
            >
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-xl mx-auto">
            {EXAMPLE_TILES.map(({ emoji, label }) => (
              <div
                key={label}
                className="flex flex-col items-center gap-2 bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-5"
              >
        ...
        <section id="communities" className="max-w-6xl mx-auto px-4 py-16">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 text-base">
              Find a group in your neighborhood and start sharing.
            </p>
          </div>
          ...
          {communities.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-gray-500 text-sm max-w-sm mb-6">
                It only takes a minute to create a CommonGround for your block,
                school, or community.
              </p>
              <Link
                href="/login"
                className="inline-flex items-center rounded-xl bg-terracotta text-white font-semibold px-6 py-3 hover:bg-terracotta/90 transition"
              >
                Create a community
              </Link>
            </div>
        ...
        <section className="max-w-6xl mx-auto px-4 py-20 text-center">
          <div className="max-w-xl mx-auto">
            ...
            <h2 className="text-3xl font-extrabold text-charcoal leading-tight">
              Start your own CommonGround
            </h2>
            <p className="mt-4 text-base text-gray-600 leading-relaxed">
              Create a private, invite-only community for your block, apartment
              building, school, faith group — anywhere neighbors know each other.
              It&apos;s free, takes two minutes, and makes a real difference.
            </p>
            <div className="mt-8">
              <Link
                href="/login"
                className="inline-flex items-center justify-center rounded-xl bg-terracotta text-white font-bold text-base px-8 py-3.5 hover:bg-terracotta/90 transition"
              >
                Create a community
              </Link>
            </div>
